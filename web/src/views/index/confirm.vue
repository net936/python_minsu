  ...
  <div>
    ...
    <section class="cart-page flex-view">
      <div class="left-flex">
        ...
        <a-range-picker v-model:value="pageData.receiverTime" :locale="locale" @change="onChange()" style="margin-top:16px;"/>
...
<script setup>
  ...
  // 天数
  const onChange = () => {
    let start = pageData.receiverTime[0];
    let end = pageData.receiverTime[1];
  ...
  const handleCommit = () => {
    ...
    formData.append('receiver_time', pageData.receiverTime[0].format('YYYY-MM-DD') + '至' + pageData.receiverTime[1].format('YYYY-MM-DD') || '');
